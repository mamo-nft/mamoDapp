<template>
    <div class="bg-con" style="transform: rotate(-20deg);position: absolute;width: 200%;top: -500px;left:-400px;z-index: 0;">
        <div style="background-color: #3399ff;height:300px;position: relative;z-index: 1;"></div>
